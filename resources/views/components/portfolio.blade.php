<section class="border-2 border-neon-green rounded flex flex-col p-4 w-full h-fit mt-5" id="port">
    ...
    <div class="flex flex-row flex-wrap space-y-5 justify-between content-start w-full md:w-6/12 md:mx-auto 3xl:space-y-0 2xl:w-8/12 2xl:justify-center 3xl:justify-between 3xl:w-11/12">
        <x-port-card
