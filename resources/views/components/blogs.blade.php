<section class="border-2 border-neon-green rounded flex flex-col p-4 w-full mt-5 mr-4 h-full" id="blog">
    ...
    <div class="flex flex-col md:flex-row md:justify-center lg:justify-between mt-4 flex-wrap w-11/12 mx-auto">
        @foreach($posts as $post)
            <a href="./blog/{{$post['slug']}}"
               class="border-2 border-dark-neon-green rounded flex flex-col 2xl:flex-row md:justify-between p-1.5 w-full
                      max-w-[560px] text-white space-x-4 mx-2 hover:bg-dark-neon-green/30 hover:border-neon-green hover:shadow-2xl
                      hover:shadow-dark-neon-green my-3 md:min-w-20 md:w-6/12 mb-3"
            >
