    ...
    <div class="flex flex-row justify-between mt-4 flex-wrap w-11/12 mx-auto">
        @foreach($posts as $post)
            <a href="./blog/{{$post['title']}}"
               class="border-2 border-dark-neon-green rounded flex flex-row justify-between p-1.5 w-3/12 mb-3 text-white space-x-4 mx-2 hover:bg-dark-neon-green/30 hover:border-neon-green hover:shadow-2xl hover:shadow-dark-neon-green">
