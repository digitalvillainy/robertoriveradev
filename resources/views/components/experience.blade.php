<section class="border-2 border-neon-green rounded flex flex-col p-1.5 h-full lg:h-[72.5vh]">
    ...
    <div class="flex flex-row justify-between md:w-[27.3em] md:mx-auto">
        <div
            class="flex flex-col lg:flex-row place-items-start lg:justify-between h-full md:w-80 lg:w-[89em] lg:mx-auto py-8 space-y-6">
            <div
                x-data="{screenWidth: window.innerWidth, position: 'left'}"
                x-init="position = screenWidth > 768 ? 'left' : 'right';"
                class="flex flex-col justify-between h-full lg:h-3/5">
                <x-exp-card
        ...
        <div class="lg:hidden bg-white w-2 min-h-full"></div>
    </div>
</section>
