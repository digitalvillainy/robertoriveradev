<section class="border-2 border-neon-green rounded flex flex-col p-1.5 h-full xl:h-[72.5vh]">
    <span class="text-neon-green w-full text-2xl text-right">EXPERIENCE</span>
    <div class="flex flex-row justify-between md:w-[27.3em] lg:w-[30em] md:mx-auto">
